package ru.andreev.homework.streamapi.transactions;
...
public class TransactionsTask {
    ...
    public static void main(String[] args) {
        ...
        Map <String,Long> map =
                transactionStream.collect(Collectors.toMap(
                        el-> el.getAccount().getNumber(),
                        el-> el.getSum(),
                        (el1,el2) -> el1
                ));
        //  2. найти сумму транзакций по всем аккаунтам
         long summer = transactionStream.mapToLong(el->el.getAccount().getBalance()).sum();
